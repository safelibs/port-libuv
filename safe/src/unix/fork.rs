...
unsafe fn reset_loop_mutex(loop_: *mut abi::uv_loop_t) -> i32 {
    unsafe {
...
unsafe fn reset_loop_rwlock(loop_: *mut abi::uv_loop_t) -> i32 {
    unsafe {
...
unsafe fn reset_threadpool_completion_state(loop_: *mut abi::uv_loop_t) {
    unsafe {
        queue::init(std::ptr::addr_of_mut!((*loop_).wq));
    }
}

pub(crate) unsafe fn loop_fork(loop_: *mut abi::uv_loop_t) -> i32 {
